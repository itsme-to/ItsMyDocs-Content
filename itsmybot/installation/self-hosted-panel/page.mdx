...
5. You can now go back to the user panel of Pterodactyl, select the server you just created and follow the [Hosting Provider](/itsmybot/installation/hosting-provider) guide to run the bot.
