...
<Properties>
  <Property name="content" type="string">
    ...
    - Hide a line if it's start with `show=false`. (Useful with placeholder)
  </Property>
...
<Properties>
  ...
  <Property name='show' type='string'>
    Hide the field if it's return `false`. (Useful with placeholder)
  </Property>
</Properties>
...
embeds: 
  - title: 
    ...
    fields:
      ...
      - name: "Field 2"
        value: "Value 2"
        show: '%show_field2%' # Hide the field if it's return 'false'.
    image: 
      - "https://example.com/image.png"
