...
## Invite Tracker
Retrieve the information of Invite Tracker. Need the [Invite Tracker](https://builtbybit.com/r/51993/) plugin
...
## Tickets
Retrieve the information of Tickets.  Need the [Tickets](https://builtbybit.com/r/51625/) plugin
...
## McStatus
Get the status of a Minecraft server. Need the [McStatus](https://builtbybit.com/r/31222/) plugin
